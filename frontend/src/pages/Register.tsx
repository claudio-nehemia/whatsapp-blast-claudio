    ...
    <div className="min-h-screen w-screen flex items-center justify-center bg-slate-50 px-4 relative">
      ...
      <div className="w-full max-w-md bg-white border border-zinc-200 rounded-2xl p-8 shadow-xl relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-extrabold text-zinc-800 tracking-tight">{t('register')}</h1>
          <p className="text-xs text-zinc-500 mt-1">Get started with WhatsApp Blast Platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-xs font-bold text-zinc-600">{t('name')}</label>
